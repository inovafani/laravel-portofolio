    ...
    <form action="{{route('experience.store')}}" method="POST">
        ...
        <div class="mb-3">
            ...
            <input
                ...
                name="info1"
                id="info1"
                aria-describedby="helpId" value="{{Session::get('info1')}}"
            />
        </div>
        <div class="mb-3">
            <div class="row">
                ...
                <div class="col-auto">
                    <input type="date" class="form-control form-control-sm" name="tgl_mulai" placeholder="dd/mm/yy" value="{{Session::get('tgl_mulai')}}"> 
                </div>
                <div class="col-auto">Tanggal Akhir</div>
                <div class="col-auto">
                    <input type="date" class="form-control form-control-sm" name="tgl_akhir" placeholder="dd/mm/yy" value="{{Session::get('tgl_akhir')}}">
                </div>
            </div>
        </div>
        <div class="mb-3">
